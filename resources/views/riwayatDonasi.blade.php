                ...
                <?php if ($donasi) { ?>
                    <div class="row" style="justify-content: center;">
                        <div class="col-lg-8" data-aos="fade-up">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Donasi {{$item['nama_donasi']}}</h5>
                                    <p class="card-text">Detail donasi : Telah didonasikan {{$item['nama_donasi']}} sejumlah {{$item['jumlah_donasi']}} {{$item['satuan']}}
                                        <br>Kepada : {{$item['nama_panti']}}
                                        <br>Status donasi :
                                        <?php if ($item['status'] == "blm_verif") {
                                            echo "Donasi belum diverifikasi";
                                        } else {
                                            echo "Donasi sudah diterima";
                                        } ?>
                                    </p>

                                    <p class="card-text">
                                        <small class="text-muted section-title">
                                            <a href="https://api.beenanti.org/bukti_donasi/{{$item['bukti_tanda_terima']}}" class="text-warning stretched-link">
                                                Bukti donasi Anda
                                        </small></a>
                                    </p>
