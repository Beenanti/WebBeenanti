        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2><b>Ajukan Kunjungan Kepada {{$panti['nama_panti']}}</b></h2>
                </div>
                <div class="row" style="justify-content: center;">
                    <div class="col-lg-6" data-aos="fade-up">
                        ...
                        @endif
                        <form action="/kunjungan/tambah" method="post" data-aos="fade-up" enctype="multipart/form-data">
                            {{ csrf_field()}}
                            ...
                            <div class="form-group mt-3">
                                <input placeholder="Durasi kegiatan kunjungan" type="text" class="form-control" name="durasi" id="durasi" required>
                            </div>
                            <div class="form-group mt-3">
                                <textarea placeholder="Detail kegiatan kunjungan" class="form-control" name="detail" rows="5" required></textarea>
                            </div>
                            <div class="form-group mt-3">
                                <!-- <label class="col-md-3 control-label" for="berkas">Dokumen</label> -->
                                <p>Masukkan Dokumen Pengajuan Kunjungan</p>
