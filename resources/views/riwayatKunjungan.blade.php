        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2><b>Riwayat Kunjungan Anda</b></h2>
                </div> <?php if ($kunj) { ?>

                    <div class="row" style="justify-content: center;">
                        <div class="col-lg-8" data-aos="fade-up">
                            @foreach ($kunj as $item)
                            <div class="card mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Kunjungan ke {{$item['panti']}}</h5>
                                    <p class="card-text">Detail kunjungan : Telah dijadwalkan kunjungan pada tanggal {{$item['tanggal']}} pukul {{$item['waktu']}} selama kurang lebih {{$item['durasi']}}
                                        <br>Detail kegiatan : {{$item['detail']}}
                                        <br>Status kunjungan :
                                        <?php if ($item['status'] == "blm_verif") {
                                            echo "Kunjungan belum diverifikasi";
                                        } else {
                                            echo "Kunjungan sudah diverifikasi";
                                        } ?>
                                    </p>
                ...
                <?php } else { ?>
                    <div class="section-title">
                        <p>Anda belum memiliki riwayat pengajuan kunjungan</p>
                    </div>
                <?php } ?>
            </div>
        </section>
