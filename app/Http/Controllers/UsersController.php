...
class UsersController extends Controller
{
    function index(Request $request){
        ...
        $response = Http::withToken(
            $token
        )->get('https://api-beenanti.ramerion.com/user');
    ...
    public function tambahAdmin(Request $request){
        ...
        $response=Http::withToken(
            $token
        )->post('https://api-beenanti.ramerion.com/auth/master/register',[
            'email' => $request->email, 
            'nama'=> $request->nama,
    ...
    public function tambahAdminPanti(Request $request){
        ...
        $response=Http::withToken($token) 
            ->post('https://api-beenanti.ramerion.com/user/admin-panti/register',[
